...
//    }
    ...
    @Bean
    public ProducerFactory<String, ListsInfoUpdateMessage> LIUMessageProducerFactory() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(
                ProducerConfig.BOOTSTRAP_SERVERS_CONFIG,
                bootstrapAddress);
    ...
    @Bean
    public KafkaTemplate<String, ListsInfoUpdateMessage> LIUMessageKafkaTemplate() {
