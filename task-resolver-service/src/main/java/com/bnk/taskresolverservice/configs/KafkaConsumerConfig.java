...
//    }
    ...
    public ConsumerFactory<String, ListsInfoUpdateMessage> LIUMessageConsumerFactory() {
        ...
        props.put(
                ConsumerConfig.GROUP_ID_CONFIG,
                "foo");//TODO: разобраться с group id
        props.put(
                ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG,
                StringDeserializer.class);
//        JsonDeserializer<ListsInfoUpdateMessage> listsInfoUpdateMessageJsonDeserializer =
//                new JsonDeserializer<>(ListsInfoUpdateMessage.class);
//        listsInfoUpdateMessageJsonDeserializer.addTrustedPackages("*");
